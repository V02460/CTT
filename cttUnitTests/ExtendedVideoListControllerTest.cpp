...
void ExtendedVideoListControllerTest::testRun() {
	...
	::model::saveable::SaveableList<::model::filter::FilteredVideo>::sptr videoList1(new ::model::saveable::SaveableList<::model::filter::FilteredVideo>());
	::model::saveable::SaveableList<::model::filter::FilteredVideo>::sptr videoList2(new ::model::saveable::SaveableList<::model::filter::FilteredVideo>());
	::model::saveable::SaveableList<::model::player::Player>::sptr playerList(new ::model::saveable::SaveableList<::model::player::Player>());
