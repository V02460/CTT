...
/**
 *	The PlayerWidget holds the VideoWidget displaying the original and the filtered video. The main purpose of this class is to handle
 *	the activation of a specific player by the user
 */
class PlayerWidget {
public slots:
	/**
