 ...
 * It is only possible to save variables as strings, but casting them to different types is hidden behind the methods of this class.
 * Furthermore pointers will be saved as voidpointer. Those two restrictions are the reason savable classes need to know what variable- /
 * pointer-types they use and use the correct method / cast to the correct pointer type.
 */
class Memento {
...
public:
	 ...
	 * @throws InvalidArgumentException Is thrown if there is no variable with given name or the variable with given name can not be cast to a boolean.
	 */
	...
	*/
	 ...
	 * @throws InvalidArgumentException Is thrown if there is no variable with given name or the variable with given name can not be cast to an integer.
	 */
	 ...
	 * @throws InvalidArgumentException Is thrown if there is no variable with given name or the variable with given name can not be cast to a float.
	 */
	 ...
	 * @throws InvalidArgumentException Is thrown if there is no variable with given name or the variable with given name can not be cast to a double.
	 */
