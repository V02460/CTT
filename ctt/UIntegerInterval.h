...
public:
	...
	*/
    ...
    /**
     * Checks whether this interval has an intersection with the submitted interval which isn't empty, i.e. whether the union of the intervals is an interval.
     *
    ...
    /**
     * Makes this interval a union of itself and the submitted interval. This only works if the union is an interval itself.
     *
     * @param interval the interval will be merged with this interval
	 * @throws IllegalArgumentException if the the interception between this interval and the submitted interval is empty
     */
